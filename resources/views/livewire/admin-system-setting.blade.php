<div class="bg-gray-50 dark:bg-dark-3/50 rounded-md p-5 my-4">
    ...
    <div class="space-y-4">
        <div>
            ...
            <input wire:model.live.defer="key" type="text" class="w-full rounded-md border-gray-300 dark:border-dark-4 dark:bg-dark-2 text-gray-700 dark:text-gray-300 focus:border-primary-500 focus:ring-primary-500" value="ABECert">
        </div>
        
        <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">პარამეტრი</label>
            <input wire:model.live.defer="value" type="text" class="w-full rounded-md border-gray-300 dark:border-dark-4 dark:bg-dark-2 text-gray-700 dark:text-gray-300 focus:border-primary-500 focus:ring-primary-500" value="info@abecert.ge">
        </div>
        <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">აღწერა</label>
            <div class="p-3 bg-white dark:bg-dark-2 border border-gray-200 dark:border-dark-4 rounded-md text-gray-700 dark:text-gray-300">
