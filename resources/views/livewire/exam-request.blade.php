<div class="col-span-1 md:col-span-2 lg:col-span-4">
    <div 
         class="bg-white dark:bg-dark-2 rounded-md border border-gray-100 dark:border-gray-800 p-8">
        <!-- Header -->
        <div class="flex flex-col items-center">
            <div class="p-4 rounded-md bg-gradient-to-br from-primary-50 to-primary-100/50 dark:from-primary-400/10 dark:to-primary-400/5 mb-4">
            ...
            <div class="flex flex-col items-center space-y-4 w-full max-w-sm">
                {{-- @if(!$examRequests)
                    <button wire:click="requestExam" 
                            class="w-full px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-md font-medium 
                ...
                <button wire:click="startExam" 
                        ...
                        class="w-full px-6 py-3 bg-green-500 hover:bg-green-600 text-white rounded-md font-medium 
                                disabled:opacity-70 disabled:cursor-not-allowed">
                ...
                @if($approvedExamRequest)
                    <button wire:click="cancelExam" 
                            class="w-full px-6 py-3 bg-red-500 hover:bg-red-600 text-white rounded-md font-medium 
                ...
                @if($nonApprovedExamRequest)
                    <div class="w-full p-4 bg-yellow-50 dark:bg-yellow-400/10 border border-yellow-100 dark:border-yellow-400/20 rounded-md">
                        <div class="flex items-center gap-3">
                            <div class="flex-shrink-0 p-2 rounded-md bg-yellow-100 dark:bg-yellow-400/20">
    ...
    <!-- Exam Instructions -->
    <div class="mt-6 p-5 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800/30 rounded-md">
        <div class="flex items-start gap-3">
            <div class="flex-shrink-0 p-2 mt-1 rounded-md bg-blue-100 dark:bg-blue-800/30">
