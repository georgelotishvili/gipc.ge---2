<div>
    ...
    <div class="py-12 px-4 mx-auto max-w-screen-xl lg:px-6">
        ...
        <div class="flex justify-center items-center mb-12">
            <div
                class="flex items-center bg-white/50 backdrop-blur-sm dark:bg-gray-800/50 rounded-2xl p-2 shadow-lg border border-blue-100/50 dark:border-blue-900/50">
                <template x-for="(plan, type) in plans" :key="type">
                    <label class="relative flex items-center p-2 rounded-xl cursor-pointer"
                        :class="{ 'opacity-75': selectedPlan !== type }">
                        <input type="radio" name="pricing-plan" :value="type" class="sr-only peer"
                            x-model="selectedPlan">
                        <span
                            class="w-full h-full absolute inset-0 rounded-xl peer-checked:bg-gradient-to-br from-blue-500 to-blue-600 peer-checked:text-white transition-all duration-300 opacity-0 peer-checked:opacity-100 shadow-xl"></span>
                        <span
        ...
        <div class="max-w-2xl mx-auto">
            <div class="relative p-8 mx-auto text-center bg-white/80 backdrop-blur-sm rounded-3xl border border-blue-100/50 shadow-2xl dark:bg-gray-800/80 dark:border-blue-900/50 transform transition-all duration-500 hover:scale-[1.02]"
                ...
                <div class="absolute -top-5 left-1/2 transform -translate-x-1/2"
                    ...
                    <span
                        class="inline-flex items-center px-6 py-2 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 text-white text-sm font-semibold shadow-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    <template x-for="option in plans[selectedPlan].options" :key="option.id">
                        <div
                            class="flex items-center space-x-3 text-left p-4 bg-gradient-to-br from-blue-50 to-blue-50/50 dark:from-blue-900/20 dark:to-blue-900/10 rounded-xl backdrop-blur-sm">
                            <div
                                class="flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-lg bg-blue-600/10 dark:bg-blue-400/10">
    ...
    <div x-show="$wire.showAgreementModal" 
        ...
        <div class="flex min-h-full items-center justify-center p-4">
            <div class="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-gray-800 p-6 text-left align-middle shadow-2xl transition-all"
                 x-transition:enter="transition ease-out duration-300"
                ...
                <!-- Checkbox -->
                <div class="mb-6">
                    <label class="flex items-start space-x-3 cursor-pointer p-3 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                        <input type="checkbox" 
                ...
                <div class="flex space-x-3">
                    <button @click="$wire.closeModal()"
                            class="flex-1 px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 border border-transparent rounded-lg hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 transition-colors">
                        გაუქმება
                    </button>
                    <button @click="if($wire.agreementAccepted) { $wire.acceptAgreement() }"
                            ...
                            class="flex-1 px-4 py-2 text-sm font-medium text-white border border-transparent rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 transition-colors">
                        გაგრძელება
                    </button>
                </div>
            </div>
