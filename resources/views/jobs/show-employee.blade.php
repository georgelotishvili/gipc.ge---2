    ...
    <div class="min-h-screen relative overflow-hidden">
        ...
        @if (session('success'))
            <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
                <div class="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-800/30 text-green-800 dark:text-green-200 px-6 py-4 rounded-2xl backdrop-blur-sm shadow-lg">
            ...
            <div class="bg-gradient-to-br from-blue-50/50 via-purple-50/50 to-indigo-50/50 dark:from-blue-900/20 dark:via-purple-900/20 dark:to-indigo-900/20 rounded-3xl p-8 border border-blue-100/50 dark:border-blue-800/30 backdrop-blur-sm">
                        ...
                        <div class="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-6">
                            <div class="flex flex-col md:flex-row items-center md:items-end md:space-y-0 md:space-x-6 text-center md:text-left pt-4 md:pt-0">
                                ...
                                <div class="relative flex-shrink-0">
                                    ...
                                    @else
                                        <div class="w-28 h-28 sm:w-32 sm:h-32 md:w-48 md:h-48 bg-white dark:bg-gray-700 rounded-full border-4 border-white dark:border-gray-600 shadow-2xl flex items-center justify-center ring-4 ring-white/20 dark:ring-gray-600/20">
                    ...
                    <div class="p-8 space-y-8">
                        ...
                        <div class="mt-4 sm:mt-6">
                            ...
                            <div class="flex flex-wrap gap-1.5 sm:gap-2">
                                @foreach(explode(',', $employee->skills) as $skill)
                                    <span class="px-2 py-1 sm:px-3 sm:py-1 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-200 rounded-full text-xs sm:text-sm font-medium">{{ trim($skill) }}</span>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700/50">
                            ...
                            <div class="flex items-start space-x-3 sm:space-x-4">
                                <div class="w-8 h-8 sm:w-10 sm:h-10 bg-indigo-100 dark:bg-indigo-900/30 rounded-xl flex items-center justify-center shadow-sm flex-shrink-0">
                                    <svg class="w-4 h-4 sm:w-5 sm:h-5 text-indigo-600 dark:text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        @foreach(explode(',', $employee->social) as $socialLink)
                                            <a href="{{ trim($socialLink) }}" target="_blank" 
                                               class="inline-flex items-center px-2 py-1 sm:px-3 sm:py-1 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 text-xs sm:text-sm font-medium rounded-full border border-indigo-200 dark:border-indigo-700/50 hover:bg-indigo-100 dark:hover:bg-indigo-900/50 transition-colors duration-200">
                ...
                <div class="flex flex-col sm:flex-row gap-4 mt-8 pt-6 border-t border-gray-200 dark:border-gray-700/50">
                    <a href="{{ route('employees.edit', $employee) }}" 
                       class="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-500 via-purple-500 to-indigo-500 hover:from-blue-600 hover:via-purple-600 hover:to-indigo-600 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                    ...
                    <form action="{{ route('employees.destroy', $employee) }}" method="POST" class="inline">
                        ...
                        <button type="submit" onclick="return confirm('დარწმუნებული ხართ?')" 
                                class="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
