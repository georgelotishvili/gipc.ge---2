<x-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="bg-white dark:bg-gray-800/50 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700/50 backdrop-blur-sm p-6 mb-8">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">რეზიუმეს შექმნა</h1>
            ...
            <form action="{{ route('employees.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="space-y-2">
                    <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">სახელი და გვარი</label>
                ...
                <div class="space-y-2">
                    <label for="position" class="block text-sm font-medium text-gray-700 dark:text-gray-300">სასურველი პოზიცია</label>
                ...
                <div class="space-y-2">
                    <label for="worktime" class="block text-sm font-medium text-gray-700 dark:text-gray-300">სასურველი სამუშაო დრო</label>
                ...
                <div class="space-y-2">
                    <label for="salary" class="block text-sm font-medium text-gray-700 dark:text-gray-300">სასურველი ხელფასი (არასავალდებულო)</label>
                ...
                <div class="space-y-2">
                    <label for="description" class="block text-sm font-medium text-gray-700 dark:text-gray-300">თქვენი გამოცდილება და კვალიფიკაცია</label>
                    <textarea name="description" id="description" rows="5" 
                        class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-transparent shadow-sm transition-all duration-200 text-gray-900 dark:text-white" required>{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="space-y-2">
                    <label for="skills" class="block text-sm font-medium text-gray-700 dark:text-gray-300">უნარები (მძიმით გამოყოფილი)</label>
                ...
                <div class="space-y-2">
                    ...
                    <div class="space-y-3">
                        <input type="email" name="email" id="email" placeholder="ელ-ფოსტა" value="{{ old('email') }}" 
                            class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-transparent shadow-sm transition-all duration-200 text-gray-900 dark:text-white" required>
                        
                        <input type="text" name="phone" id="phone" placeholder="ტელეფონი" value="{{ old('phone') }}" 
                            class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-transparent shadow-sm transition-all duration-200 text-gray-900 dark:text-white">
                        
                        <input type="url" name="website" id="website" placeholder="პორტფოლიო/ვებსაიტი (არასავალდებულო)" value="{{ old('website') }}" 
                            class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-transparent shadow-sm transition-all duration-200 text-gray-900 dark:text-white">
                            
                        <input type="text" name="social" id="social" placeholder="სოციალური ქსელები (მძიმით გამოყოფილი, არასავალდებულო)" value="{{ old('social') }}" 
                            class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-transparent shadow-sm transition-all duration-200 text-gray-900 dark:text-white">
                    </div>
                    @error('email')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                ...
                <div class="space-y-2">
                    <label for="image" class="block text-sm font-medium text-gray-700 dark:text-gray-300">პროფილის ფოტო (არასავალდებულო)</label>
