<x-layout>
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="bg-white dark:bg-gray-800/50 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700/50 backdrop-blur-sm overflow-hidden">
            ...
            <div class="relative h-48 bg-gradient-to-r from-primary-800 to-primary-600">
                <div class="absolute bottom-0 left-0 w-full p-6 bg-gradient-to-t from-black/60 to-transparent">
                    <h1 class="text-3xl font-bold text-white">{{ $employer->position }}</h1>
                    <p class="text-white/90 text-lg">{{ $employer->name }}</p>
                </div>
            </div>

            <!-- Company Logo/Image -->
            <div class="px-6 -mt-16 relative z-10 flex justify-between items-end">
                <div class="bg-white dark:bg-gray-800 rounded-xl p-2 shadow-lg border border-gray-100 dark:border-gray-700">
                    @if($employer->image)
