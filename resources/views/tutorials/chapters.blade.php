            ...
            @if($course->chapters->count() > 0)
                ...
                <div class="max-w-4xl mx-auto space-y-4 lg:hidden">
                    @foreach($course->chapters as $index => $chapter)
                        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700" x-data="{ open: false }">
                            <!-- Chapter Header -->
                ...
                <div class="max-w-4xl mx-auto space-y-4 hidden lg:block">
                    @foreach($course->chapters as $index => $chapter)
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-md transition-all duration-300" x-data="{ open: false }">
                            ...
                            <button @click="open = !open" class="w-full p-5 text-left focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-200">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
                                                <span class="flex items-center gap-2 px-3 py-1.5 bg-blue-50 dark:bg-blue-900/20 rounded-full">
                                                    <i class="fas fa-video text-blue-500"></i>
                                                    <span class="font-medium">{{ $chapter->videos->count() }} ვიდეო</span>
                                                </span>
                                                <span class="flex items-center gap-2 px-3 py-1.5 bg-gray-50 dark:bg-gray-700 rounded-full">
                                    ...
                                    <div class="flex items-center gap-3 flex-shrink-0">
                                        ...
                                        <div class="w-10 h-10 bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-center transition-transform duration-300" :class="{ 'rotate-180': open }">
