<x-admin.layout>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 2xl:grid-cols-4 gap-4 sm:gap-5 lg:gap-6 mb-12 mt-4">
        <!-- Users Stats -->
        <div class="group bg-white dark:bg-dark-2/50 backdrop-blur-xl rounded-md p-5 sm:p-6 transition-all duration-500 shadow-[0_2px_8px_rgb(0,0,0,0.08)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] dark:border-dark-4/50 relative overflow-hidden">
            ...
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center">
                    <div class="p-3 rounded-md bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 group-hover:scale-110 transition-transform duration-500 shadow-sm">
            ...
            <div class="flex items-center justify-between gap-3">
                <button class="flex-1 px-3 sm:px-4 py-2.5 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-md hover:from-blue-700 hover:to-blue-600 transition-all duration-300 text-xs sm:text-sm font-medium shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 hover:-translate-y-0.5 focus:ring-2 focus:ring-blue-500/60 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-dark-2">
                    დამატება
                </button>
                <button class="flex-1 px-3 sm:px-4 py-2.5 bg-gradient-to-r from-blue-600/10 to-blue-500/10 text-blue-700 dark:text-blue-300 rounded-md hover:from-blue-600/20 hover:to-blue-500/20 transition-all duration-300 text-xs sm:text-sm font-medium hover:-translate-y-0.5 focus:ring-2 focus:ring-blue-500/60 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-dark-2">
                    დეტალურად
                </button>
            </div>
        </div>
        ...
        <div class="group bg-white dark:bg-dark-2/50 backdrop-blur-xl rounded-md p-5 sm:p-6 transition-all duration-500 shadow-[0_2px_8px_rgb(0,0,0,0.08)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] dark:border-dark-4/50 relative overflow-hidden">
            ...
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center">
                    <div class="p-3 rounded-md bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/30 dark:to-emerald-800/30 group-hover:scale-110 transition-transform duration-500 shadow-sm">
            ...
            <div class="flex justify-end">
                <button class="px-6 py-2.5 bg-gradient-to-r from-emerald-600 to-emerald-500 text-white rounded-md hover:from-emerald-700 hover:to-emerald-600 transition-all duration-300 text-xs sm:text-sm font-medium shadow-lg shadow-emerald-500/30 hover:shadow-emerald-500/50 hover:-translate-y-0.5 focus:ring-2 focus:ring-emerald-500/60 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-dark-2">
                    ყველა
                </button>
            </div>
        </div>
        ...
        <div class="group bg-white dark:bg-dark-2/50 backdrop-blur-xl rounded-md p-5 sm:p-6 transition-all duration-500 shadow-[0_2px_8px_rgb(0,0,0,0.08)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] dark:border-dark-4/50 relative overflow-hidden">
            ...
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center">
                    <div class="p-3 rounded-md bg-gradient-to-br from-violet-50 to-violet-100 dark:from-violet-900/30 dark:to-violet-800/30 group-hover:scale-110 transition-transform duration-500 shadow-sm">
            ...
            <div class="flex justify-end gap-3">
                <button class="px-4 py-2.5 bg-gradient-to-r from-violet-600 to-violet-500 text-white rounded-md hover:from-violet-700 hover:to-violet-600 transition-all duration-300 text-xs sm:text-sm font-medium shadow-lg shadow-violet-500/30 hover:shadow-violet-500/50 hover:-translate-y-0.5 focus:ring-2 focus:ring-violet-500/60 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-dark-2">
                    დამატება
                </button>
                <button class="px-4 py-2.5 bg-gradient-to-r from-violet-600/10 to-violet-500/10 text-violet-700 dark:text-violet-300 rounded-md hover:from-violet-600/20 hover:to-violet-500/20 transition-all duration-300 text-xs sm:text-sm font-medium hover:-translate-y-0.5 focus:ring-2 focus:ring-violet-500/60 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-dark-2">
                    ყველა
                </button>
            </div>
        </div>
        ...
        <div class="group bg-white dark:bg-dark-2/50 backdrop-blur-xl rounded-md p-5 sm:p-6 transition-all duration-500 shadow-[0_2px_8px_rgb(0,0,0,0.08)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] dark:border-dark-4/50 relative overflow-hidden">
            ...
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center">
                    <div class="p-3 rounded-md bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/30 dark:to-amber-800/30 group-hover:scale-110 transition-transform duration-500 shadow-sm">
