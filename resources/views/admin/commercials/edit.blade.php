        ...
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 rounded-md shadow-sm overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('admin.commercials.update', $commercial) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       name="name" 
                                       id="name" 
                                       value="{{ old('name', $commercial->name) }}"
                                       required
                            ...
                            <div>
                                ...
                                <input type="url" 
                                       name="link" 
                                       id="link" 
                                       value="{{ old('link', $commercial->link) }}"
                                       class="w-full rounded-md border border-gray-300 dark:border-gray-700 dark:bg-dark-3 px-4 py-2 focus:border-primary-500 focus:ring-primary-500">
                                @error('link')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="date" 
                                       ...
                                       id="expiration_date" 
                                       value="{{ old('expiration_date', $commercial->expiration_date ? $commercial->expiration_date->format('Y-m-d') : '') }}"
                                       class="w-full rounded-md border border-gray-300 dark:border-gray-700 dark:bg-dark-3 px-4 py-2 focus:border-primary-500 focus:ring-primary-500">
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       name="weight" 
                                       id="weight" 
                                       value="{{ old('weight', $commercial->weight) }}"
                                       min="1"
                                       required
                                       class="w-full rounded-md border border-gray-300 dark:border-gray-700 dark:bg-dark-3 px-4 py-2 focus:border-primary-500 focus:ring-primary-500">
                                @error('weight')
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       id="duration_weight" 
                                       value="{{ old('duration_weight', $commercial->duration_weight) }}"
                                       min="1"
                                       required
                                       class="w-full rounded-md border border-gray-300 dark:border-gray-700 dark:bg-dark-3 px-4 py-2 focus:border-primary-500 focus:ring-primary-500">
                            ...
                            <div class="md:col-span-2">
                                ...
                                @if($commercial->image_link)
                                    <img src="{{ $commercial->getImageLinkAttribute() }}" 
                                         alt="{{ $commercial->name }}" 
                                         class="h-32 w-auto object-cover rounded-md">
                                @else
                                    <p class="text-gray-500 dark:text-gray-400">სურათი არ არის</p>
                                @endif
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="description" 
                                          id="description" 
                                          rows="4" 
                                          class="w-full rounded-md border border-gray-300 dark:border-gray-700 dark:bg-dark-3 px-4 py-2 focus:border-primary-500 focus:ring-primary-500">{{ old('description', $commercial->description) }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
