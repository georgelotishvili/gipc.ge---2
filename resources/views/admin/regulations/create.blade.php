<x-admin.layout>
    <div class="bg-white dark:bg-dark-2 rounded-md shadow-lg overflow-hidden">
        <div class="p-6 sm:p-8 border-b border-gray-200 dark:border-dark-4">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">რეგულაციის ბმულის დამატება</h2>
            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                დაამატეთ დოკუმენტის სახელი და ოფიციალური ბმული. შენახვის შემდეგ ჩანაწერი გამოჩნდება საჯარო გვერდზე.
            </p>
        </div>

        <form action="{{ route('admin.regulations.store') }}" method="POST" class="p-6 sm:p-8 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-6">
                <div>
                    ...
                    <input type="text"
                           ...
                           value="{{ old('name') }}"
                           required
                           placeholder="მაგ: შენობა-ნაგებობის უსაფრთხოების წესები"
