<x-admin.layout>
    <div class="bg-white dark:bg-dark-2 rounded-md shadow-lg p-8">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('admin.regulations.create') }}" class="px-5 py-2.5 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors duration-300 flex items-center shadow-md hover:shadow-lg transform">
                ...
                <div class="bg-gray-50 dark:bg-dark-3 rounded-md p-6 shadow hover:bg-gray-100 dark:hover:bg-dark-4 transition-colors duration-200">
                    <div class="flex justify-between items-start">
                        ...
                        <div class="flex space-x-2">
                            <a href="{{ route('admin.regulations.edit', $regulation) }}" class="p-2 text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300 rounded-md hover:bg-indigo-50 dark:hover:bg-indigo-500/10">
