<x-admin.layout>
    <div class="bg-white dark:bg-dark-2/50 backdrop-blur-xl rounded-2xl p-5 sm:p-6 transition-all duration-500 shadow-[0_2px_8px_rgb(0,0,0,0.08)] dark:border-dark-4/50">
        <div class="mb-6">
        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div class="bg-gray-50 dark:bg-dark-3/50 rounded-xl p-5">
