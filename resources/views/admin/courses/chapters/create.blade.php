        ...
        <div class="relative z-10 max-w-[1920px] mx-auto px-6 py-8">
            ...
            <div class="text-center mb-16">
                <h1 class="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                    ახალი <span class="bg-gradient-to-r from-primary-400 to-blue-400 bg-clip-text text-transparent">თავის</span> დამატება
                </h1>
                <p class="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                    შეავსეთ ფორმა ახალი თავის დასამატებლად
                </p>
            </div>
            ...
            <div class="max-w-2xl mx-auto">
                <form action="{{ route('admin.courses.chapters.store', $course) }}" method="POST" class="space-y-6" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="bg-white dark:bg-dark-2 rounded-xl p-6 shadow-sm">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="description" 
                                      ...
                                      rows="4" 
                                      class="w-full rounded-md border border-gray-300 dark:border-gray-700 dark:bg-dark-3 px-4 py-2 focus:border-primary-500 focus:ring-primary-500"
                                      placeholder="შეიყვანეთ თავის აღწერა"></textarea>
                        </div>
