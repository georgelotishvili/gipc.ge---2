    ...
    <div class="min-h-screen bg-white dark:bg-dark relative overflow-hidden">
        <div class="relative z-10 max-w-[1920px] mx-auto px-6 py-8">
            ...
            <div class="mb-8 flex justify-between items-center">
                ...
                <a href="{{ route('admin.courses.createVideo', ['course' => $course->id, 'chapter' => $chapter->id]) }}" 
                ...
                <div class="max-w-4xl mx-auto space-y-4">
                    ...
                    <div class="bg-white dark:bg-dark-2 rounded-md shadow-sm flex">
                        <div class="w-48 h-32 relative bg-gray-100 dark:bg-dark-3 rounded-l-md flex-shrink-0">
                            @if($video->thumbnail)
                                <img src="{{ Storage::url($video->thumbnail) }}" alt="{{ $video->title }}" class="absolute inset-0 w-full h-full object-cover rounded-l-md">
                            @else
                        ...
                        <div class="p-4 flex-grow flex justify-between">
                            <div class="flex flex-col justify-between">
                                ...
                                <div class="text-sm text-gray-500">
                                    <span>{{ $video->duration }} წუთი</span>
                                </div>
                            </div>
                            
                            <div class="flex flex-col justify-between items-end">
                                <div class="flex gap-2">
                                    <a href="{{ route('admin.courses.editVideo', ['course' => $course->id, 'chapter' => $chapter->id, 'video' => $video->id]) }}" 
                                    ...
                                    <button class="inline-flex items-center px-3 py-1.5 bg-red-500 hover:bg-red-600 text-white text-sm font-medium rounded-md transition-colors duration-200">
