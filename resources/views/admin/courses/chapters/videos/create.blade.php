        ...
        <div class="relative z-10 max-w-[1920px] mx-auto px-6 py-8">
            ...
            <div class="text-center mb-16">
                <h1 class="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                    ახალი <span class="bg-gradient-to-r from-primary-400 to-blue-400 bg-clip-text text-transparent">ვიდეოს</span> დამატება
                </h1>
            ...
            <div class="max-w-2xl mx-auto">
                <form action="{{ route('admin.courses.chapters.videos.store', [$course, $chapter]) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    ...
                    <div class="bg-white dark:bg-dark-2 rounded-xl p-6 shadow-sm">
                        ...
                        <div class="mb-6">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                დასაშვებია: MP4, MOV, AVI (მაქს. 500MB)
                            </p>
                        </div>
