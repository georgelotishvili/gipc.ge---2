        ...
        <div class="relative z-10 max-w-[1920px] mx-auto px-6 py-8">
            ...
            <div class="text-center mb-16">
                <h1 class="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                    თავის <span class="bg-gradient-to-r from-primary-400 to-blue-400 bg-clip-text text-transparent">რედაქტირება</span>
                </h1>
                <p class="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                    შეცვალეთ თავის მონაცემები
                </p>
            </div>
                ...
                <form action="{{ route('admin.courses.chapters.update', [$course, $chapter]) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="bg-white dark:bg-dark-2 rounded-md p-6 shadow-sm">
                        ...
                        <div class="mb-6">
                            ...
                            @if($chapter->image)
                                <div class="mb-4">
                                    <img src="{{ Storage::url($chapter->image->path) }}" alt="Current chapter image" class="w-32 h-32 object-cover rounded-md">
                                </div>
                            @endif
                            <input type="file" 
                                   name="image" 
