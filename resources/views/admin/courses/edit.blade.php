        ...
        <div class="relative z-10 max-w-[1920px] mx-auto px-6 py-8">
            ...
            <div class="text-center mb-16">
                <h1 class="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                    კურსის <span class="bg-gradient-to-r from-primary-400 to-blue-400 bg-clip-text text-transparent">რედაქტირება</span>
                </h1>
                <p class="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                    შეცვალეთ კურსის მონაცემები
                </p>
            </div>
                    ...
                    <div class="bg-white dark:bg-dark-2 rounded-md p-6 shadow-sm">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="description" 
                                      ...
                                      rows="4" 
                                      class="w-full rounded-md border border-gray-300 dark:border-gray-700 dark:bg-dark-3 px-4 py-2 focus:border-primary-500 focus:ring-primary-500"
                                      placeholder="შეიყვანეთ კურსის აღწერა">{{ $course->description }}</textarea>
                        </div>
