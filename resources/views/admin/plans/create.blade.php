                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="plan_type_id" id="plan_type_id"
                                    ...
                                    @foreach ($planTypes as $planType)
                                        <option value="{{ $planType->id }}" {{ old('plan_type_id') == $planType->id ? 'selected' : '' }}>{{ $planType->type_name }}</option>
                                    @endforeach
                                </select>
                                @error('plan_type_id')
                            ...
                            <div>
                                ...
                                <input type="text" name="plan_description" id="plan_description" value="{{ old('plan_description') }}" required
                                    placeholder="მაგ: სტანდარტული პლატფორმა"
                                    class="w-full rounded-md border border-gray-300 dark:border-gray-700 dark:bg-dark-3 px-4 py-2 focus:border-primary-500 focus:ring-primary-500">
                            ...
                            <!-- Price -->
                            <div>
                                <label for="plan_price" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    ფასი
                                </label>
                                <input type="number" name="plan_price" id="plan_price" value="{{ old('plan_price') }}" placeholder="მაგ: 150" required
                                    class="w-full rounded-md border border-gray-300 dark:border-gray-700 dark:bg-dark-3 px-4 py-2 focus:border-primary-500 focus:ring-primary-500">
                                @error('plan_price')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="number" name="plan_discount" id="plan_discount" placeholder="მაგ: 50"
                                    value="{{ old('plan_discount') ?? 0 }}"
                                    class="w-full rounded-md border border-gray-300 dark:border-gray-700 dark:bg-dark-3 px-4 py-2 focus:border-primary-500 focus:ring-primary-500">
                                @error('plan_discount')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <select name="plan_recommended" id="plan_recommended"
                                    ...
                                    <option value="1" {{ old('plan_recommended') == '1' ? 'selected' : '' }}>დიახ</option>
                                    <option value="0" {{ old('plan_recommended') == '0' ? 'selected' : '' }}>არა</option>
                                </select>
                            ...
                            <div>
                                ...
                                <select name="is_active" id="is_active"
                                    ...
                                    <option value="1" {{ old('is_active') == '1' ? 'selected' : '' }}>დიახ</option>
                                    <option value="0" {{ old('is_active') == '0' ? 'selected' : '' }}>არა</option>
                                </select>
                                @error('is_active')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="number" name="plan_order" id="plan_order" value="{{ old('plan_order') }}" placeholder="მაგ: 1" required
                                    class="w-full rounded-md border border-gray-300 dark:border-gray-700 dark:bg-dark-3 px-4 py-2 focus:border-primary-500 focus:ring-primary-500">
                                @error('plan_order')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
