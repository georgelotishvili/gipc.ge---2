    ...
    <div class="bg-white rounded-2xl shadow-lg p-8">
        <div class="flex justify-between items-center mb-6 gap-6">
            ...
            <div class="flex gap-2">
                <button onclick="toggleDeleteMode()" id="deleteButton" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors duration-200">
                    რამდენიმეს წაშლა
                </button>
            ...
            <div class="space-y-4">
                @foreach($questions as $question)
                    <div class="border rounded-lg overflow-hidden">
                        <div class="flex items-center justify-between p-4 bg-white hover:bg-gray-50">
                            <div class="flex items-center space-x-4">
                                <input type="checkbox" name="selected_questions[]" value="{{$question->id}}" class="rounded border-gray-300 text-primary focus:ring-primary checkbox-delete hidden">
                                ...
                                <p class="text-gray-900 cursor-pointer" onclick="document.getElementById('answers-{{$question->id}}').classList.toggle('hidden')">{{$question->text}}</p>
                            </div>
