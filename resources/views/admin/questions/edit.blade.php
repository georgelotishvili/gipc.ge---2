    ...
    <div class="max-w-4xl mx-auto bg-white dark:bg-dark-2 rounded-md shadow-lg p-8">
        ...
        <form action="{{ route('admin.questions.update', $question->id) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea id="text" name="text" rows="3" class="w-full rounded-md border-gray-300 dark:border-dark-4 dark:bg-dark-2 dark:text-white shadow-sm focus:border-primary focus:ring-primary transition duration-200">{{$question->text}}</textarea>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center space-x-4 p-4 border dark:border-dark-4 rounded-md hover:border-primary dark:hover:border-primary transition duration-200">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <button type="button" class="p-2 text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300 rounded-md hover:bg-red-50 dark:hover:bg-red-500/10 transition duration-200">
                ...
                <button type="button" class="w-full py-3 border-2 border-dashed border-gray-300 dark:border-dark-4 rounded-md text-gray-600 dark:text-gray-300 hover:border-primary dark:hover:border-primary hover:text-primary dark:hover:text-primary transition duration-200">
                    + პასუხის დამატება
                </button>
            </div>
            ...
            <div class="flex justify-end space-x-4 pt-6 border-t dark:border-dark-4">
                <a href="{{ route('admin.questions') }}" class="px-6 py-2 border border-gray-300 dark:border-dark-4 rounded-md text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-dark-3 transition duration-200">
                    გაუქმება
                </a>
                <button type="submit" class="px-6 py-2 bg-primary text-white rounded-md hover:bg-primary/90 transition duration-200">
                    შენახვა
                </button>
            </div>
        </form>
