        ...
        <div class="max-w-[120rem] mx-auto px-6 sm:px-8 lg:px-12">
            <div class="flex justify-between h-20 items-center relative">
                ...
                <div class="hidden lg:flex flex-shrink-0 items-center gap-4 sm:gap-5 2xsm:gap-8 z-10 justify-end">
                    ...
                    <button onclick="toggleDarkMode()" class="darkswitcher flex h-10 w-10 items-center justify-center rounded-md border-[0.5px] border-gray-300 dark:border-dark-4 hover:bg-gray-100 dark:hover:bg-dark-4 bg-white dark:bg-dark-2 text-gray-700 dark:text-dark-6 transition-all duration-200">
                    ...
                    {{-- <button class="relative flex h-10 w-10 items-center justify-center rounded-md border-[0.5px] border-gray-300 dark:border-dark-4 hover:bg-gray-100 dark:hover:bg-dark-4 bg-white dark:bg-dark-2 text-gray-700 dark:text-dark-6 transition-all duration-200">
                    ...
                    @auth
                        ...
                        <div x-data="{ dropdownOpen: false }" class="relative hidden lg:flex">
                            ...
                            <div x-show="dropdownOpen"
                                 ...
                                 class="absolute right-0 mt-12 w-72 rounded-md border border-gray-100/50 bg-white/95 backdrop-blur-sm shadow-xl dark:border-gray-800/50 dark:bg-gray-900/95">
                                ...
                                <div class="p-2">
                                    ...
                                    <div class="space-y-1">
                                        <a href="{{ route('workspace') }}" wire:navigate
                                           class="flex items-center w-full px-3 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-md transition-all duration-200 group">
                                            <div class="flex items-center justify-center w-8 h-8 mr-3 rounded-md bg-blue-100 dark:bg-blue-900/30 group-hover:bg-blue-200 dark:group-hover:bg-blue-800/50 transition-all duration-200">
                                        ...
                                        <a href="{{ route('profile.show') }}" wire:navigate
                                           class="flex items-center w-full px-3 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-md transition-all duration-200 group">
                                            <div class="flex items-center justify-center w-8 h-8 mr-3 rounded-md bg-green-100 dark:bg-green-900/30 group-hover:bg-green-200 dark:group-hover:bg-green-800/50 transition-all duration-200">
                                    ...
                                    <div class="mt-3 pt-3 border-t border-gray-100/50 dark:border-gray-800/50">
                                        <form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                            <button type="submit"
                                                   class="flex items-center w-full px-3 py-2.5 text-sm font-medium text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-md transition-all duration-200 group">
                                                <div class="flex items-center justify-center w-8 h-8 mr-3 rounded-md bg-red-100 dark:bg-red-900/30 group-hover:bg-red-200 dark:group-hover:bg-red-800/50 transition-all duration-200">
                ...
                @guest
                    ...
                    <div class="hidden lg:flex items-center gap-3">
                        <a href="{{ route('register') }}" wire:navigate 
                           class="flex h-10 items-center justify-center px-4 rounded-md bg-primary-600 hover:bg-primary-700 text-white transition-all duration-200 font-medium shadow-lg shadow-primary-500/20 border border-primary-500/20 hover:border-primary-500/30">
                            რეგისტრაცია
                        </a>
                        <a href="{{ route('login') }}" wire:navigate 
                           class="flex h-10 items-center justify-center px-4 rounded-md bg-white dark:bg-dark-2 hover:bg-gray-50 dark:hover:bg-dark-3 text-gray-700 dark:text-gray-300 transition-all duration-200 font-medium shadow-md border border-gray-200 dark:border-gray-700">
                            შესვლა
                        </a>
                    </div>
                @endguest
            ...
            <div class="lg:hidden" x-data="{ 
                ...
                <button @click="mobileMenuOpen = !mobileMenuOpen" 
                        class="fixed top-4 right-4 z-50 lg:hidden p-2 rounded-md bg-white dark:bg-dark-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-dark-4 focus:outline-none border border-gray-200 dark:border-gray-700">
                ...
                <div x-show="mobileMenuOpen" 
                    ...
                    <div class="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <button @click="mobileMenuOpen = false" 
                                class="p-2 rounded-md bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-dark-4 transition-all duration-200">
                            ...
                            <div class="max-w-sm mx-auto space-y-8">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <a href="/tutorials" wire:navigate @click="mobileMenuOpen = false" 
                                       class="flex items-center space-x-4 text-lg font-medium text-gray-900 dark:text-white hover:text-primary-600 dark:hover:text-primary-400 transition-all duration-200 py-4 px-6 rounded-md hover:bg-gray-50 dark:hover:bg-dark-2 group">
                                        <div class="flex items-center justify-center w-10 h-10 rounded-md bg-purple-100 dark:bg-purple-900/30 group-hover:bg-purple-200 dark:group-hover:bg-purple-800/50 transition-all duration-200">
                                    ...
                                    <a href="/pricing" wire:navigate @click="mobileMenuOpen = false" 
                                       class="flex items-center space-x-4 text-lg font-medium text-gray-900 dark:text-white hover:text-primary-600 dark:hover:text-primary-400 transition-all duration-200 py-4 px-6 rounded-md hover:bg-gray-50 dark:hover:bg-dark-2 group">
                                        <div class="flex items-center justify-center w-10 h-10 rounded-md bg-green-100 dark:bg-green-900/30 group-hover:bg-green-200 dark:group-hover:bg-green-800/50 transition-all duration-200">
                                    ...
                                    <a href="/about" wire:navigate @click="mobileMenuOpen = false" 
                                       class="flex items-center space-x-4 text-lg font-medium text-gray-900 dark:text-white hover:text-primary-600 dark:hover:text-primary-400 transition-all duration-200 py-4 px-6 rounded-md hover:bg-gray-50 dark:hover:bg-dark-2 group">
                                        <div class="flex items-center justify-center w-10 h-10 rounded-md bg-orange-100 dark:bg-orange-900/30 group-hover:bg-orange-200 dark:group-hover:bg-orange-800/50 transition-all duration-200">
                                    ...
                                    <div x-data="{ open: false }" class="">
                                        ...
                                        <div x-show="open" x-transition class="mt-2 space-y-2">
                                            ...
                                            <a href="{{ route('workspace') }}" wire:navigate @click="mobileMenuOpen = false"
                                               class="flex items-center space-x-4 text-lg font-medium text-gray-900 dark:text-white hover:text-primary-600 dark:hover:text-primary-400 transition-all duration-200 py-3 px-6 rounded-md hover:bg-gray-50 dark:hover:bg-dark-2 group">
                                                <div class="flex items-center justify-center w-10 h-10 rounded-md bg-indigo-100 dark:bg-indigo-900/30 group-hover:bg-indigo-200 dark:group-hover:bg-indigo-800/50 transition-all duration-200">
                                            ...
                                            <form method="POST" action="{{ route('logout') }}" class="mt-2">
                                                @csrf
                                                <button type="submit"
                                                        class="flex w-full items-center space-x-4 text-lg font-medium text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 transition-all duration-200 py-3 px-6 rounded-md hover:bg-red-50 dark:hover:bg-red-900/20 group">
                                                    <div class="flex items-center justify-center w-10 h-10 rounded-md bg-red-100 dark:bg-red-900/30 group-hover:bg-red-200 dark:group-hover:bg-red-800/50 transition-all duration-200">
                                ...
                                <div class="space-y-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                                    ...
                                    <a href="{{ route('register') }}" wire:navigate @click="mobileMenuOpen = false"
                                       class="block w-full text-center bg-primary-600 text-white px-5 py-3 rounded-md hover:bg-primary-700 transition-all duration-200 shadow-lg shadow-primary-500/20 font-medium border border-primary-500/20 hover:border-primary-500/30 hover:scale-[1.02] active:scale-[0.98]">
                                        რეგისტრაცია
                                    </a>
                                    <a href="{{ route('login') }}" wire:navigate @click="mobileMenuOpen = false"
                                       class="block w-full text-center bg-white dark:bg-dark-2 text-gray-700 dark:text-gray-300 px-5 py-3 rounded-md hover:bg-gray-50 dark:hover:bg-dark-3 transition-all duration-200 shadow-md border border-gray-200 dark:border-gray-700 font-medium hover:scale-[1.02] active:scale-[0.98]">
                                        შესვლა
                                    </a>
                                </div>
                                @endguest
                                ...
                                <div class="pt-6 border-t border-gray-200 dark:border-gray-700">
                                    <div class="relative p-6 rounded-md bg-gray-50 dark:bg-dark-2 border border-gray-200 dark:border-gray-700">
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center space-x-4">
                                                <div class="flex items-center justify-center w-10 h-10 rounded-md bg-gray-200 dark:bg-gray-700">
                                            ...
                                            <button onclick="toggleDarkMode()" 
                                                    class="relative flex h-12 w-20 items-center rounded-md bg-gray-200 dark:bg-gray-700 p-1 transition-all duration-300 hover:bg-gray-300 dark:hover:bg-gray-600">
                                                <div id="toggle-slider" class="h-10 w-10 bg-white dark:bg-gray-800 rounded-md shadow-sm transition-all duration-300 ease-out flex items-center justify-center">
