...
<body class="dark:bg-dark" x-init="
            ...
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="hidden lg:flex items-center justify-between flex-grow">
                    <div class="flex items-center space-x-8 mx-auto">
                        ...
                        <a href="/tutorials" class="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors font-medium">
                            ვიდეო გაკვეთილები
                        </a>
                    ...
                    <div class="flex items-center gap-2 sm:gap-3 2xsm:gap-7">
                        ...
                        <ul class="hidden xl:flex items-center gap-2 2xsm:gap-4">
                            <!-- Theme Toggle -->
                            <li>
                                <button x-data="{ darkMode: localStorage.theme === 'dark' }" 
                                        @click="darkMode = !darkMode; localStorage.theme = darkMode ? 'dark' : 'light'; document.documentElement.classList.toggle('dark')"
                                        class="flex h-9 w-9 items-center justify-center rounded-xl border-[0.5px] border-gray-300 hover:bg-gray-100 dark:border-dark-4 dark:bg-dark-2 dark:text-dark-6 dark:hover:bg-dark-4">
                    ...
                    <div class="flex items-center gap-2 sm:gap-4">
                        <a href="{{ route('login') }}" class="bg-primary-600 dark:bg-primary-500 text-white px-5 py-2.5 rounded-lg hover:bg-primary-700 dark:hover:bg-primary-600 transition-colors shadow-lg shadow-primary-500/20 dark:shadow-primary-500/10">
                            დაწყება
                        </a>
                    </div>
                    @endauth
    ...
    <div x-show="mobileMenuOpen" 
        ...
        <div class="container mx-auto px-6 py-8">
            <div class="flex flex-col space-y-6">
                <a href="/" class="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors font-medium text-lg">
                    მთავარი
                </a>
                <a href="/tutorials" class="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors font-medium text-lg">
                    ვიდეო გაკვეთილები
                </a>
                <a href="/pricing" class="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors font-medium text-lg">
                    ფასები
                </a>
                <a href="/about" class="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors font-medium text-lg">
                    ჩვენს შესახებ
                </a>
                @guest
                <a href="{{ route('login') }}" class="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors font-medium text-lg">
                    შესვლა
                </a>
                @else
                <a href="{{ route('workspace') }}" class="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors font-medium text-lg">
                    სამუშაო გვერდი
                </a>
                <a href="{{ route('logout') }}" class="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors font-medium text-lg">
                    გასვლა
                </a>
                @endguest
                <button x-data="{ darkMode: localStorage.theme === 'dark' }" 
        ...
        <div class="max-w-[120rem] mx-auto px-6 sm:px-8 lg:px-12">
            <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                <div class="flex items-center gap-8">
                    <a href="/" class="text-xl font-bold text-gray-900 dark:text-white">GIPC</a>
                    <a href="/about" class="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">ჩვენს შესახებ</a>
                    <a href="/contact" class="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">კონტაქტი</a>
                </div>
