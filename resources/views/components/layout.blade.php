...
<body class="dark:bg-dark">
    ...
    <nav class="fixed w-full bg-white/80 dark:bg-dark/80 backdrop-blur-sm z-50 border-b border-gray-100 dark:border-gray-800">
        <div class="max-w-[120rem] mx-auto px-6 sm:px-8 lg:px-12">
            <div class="flex justify-between h-20 items-center">
                    ...
                    <div class="flex items-center space-x-6">
                        ...
                        <label for="themeSwitcher" class="inline-flex cursor-pointer items-center" aria-label="themeSwitcher" name="themeSwitcher">
                            ...
                            <span class="block text-gray-600 dark:text-gray-300">
                                ...
                                <i class="fa-solid fa-moon text-xl inline dark:hidden"></i>
                            </span>
                        </label>
                        @guest
                        <a href="{{ route('login') }}" class="bg-[#0066FF] text-white px-6 py-2.5 rounded-lg hover:bg-blue-700 transition-all duration-300 shadow-lg shadow-blue-500/20 font-medium relative overflow-hidden hover:scale-105 active:scale-95 hover:shadow-blue-500/30 group">
                ...
                <div class="md:hidden">
                    <button id="mobileMenuButton" class="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white p-2">
        ...
        <div id="mobileMenu" class="hidden md:hidden">
            <div class="px-4 pt-2 pb-3 space-y-1 bg-white/80 dark:bg-dark/80 backdrop-blur-sm shadow-lg border-t border-gray-100 dark:border-gray-800">
                ...
                <a href="/about" class="block px-4 py-2.5 text-base font-medium text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors rounded-lg">
                    ჩვენს შესახებ
                </a>
                <div class="flex items-center justify-between px-4 py-2.5">
                    ...
                    <button class="bg-primary-600 dark:bg-primary-500 text-white px-5 py-2.5 rounded-lg hover:bg-primary-700 dark:hover:bg-primary-600 transition-colors shadow-lg shadow-primary-500/20 dark:shadow-primary-500/10">
                        დაწყება
                    </button>
                </div>
            </div>
