<x-layout>
    <!-- Hero Section -->
    <section class="relative rounded-md overflow-hidden py-12">
    ...
    <section class="py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                ...
                <!-- Phone Contact Card -->
                <div class="group relative overflow-hidden bg-white dark:bg-dark-3 rounded-md shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="relative p-8">
                        <!-- Icon Container -->
                        <div class="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-md mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center space-x-3">
                                <div class="w-2 h-2 bg-green-500 rounded-md animate-pulse"></div>
                        ...
                        <div class="mt-16">
                            <a href="tel:+995593222033" 
                               class="flex w-full items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-md hover:from-blue-600 hover:to-purple-700 transition-all duration-200 font-medium text-sm group-hover:shadow-lg">
                ...
                <div class="group relative overflow-hidden bg-white dark:bg-dark-3 rounded-md shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="relative p-8">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center space-x-3">
                                <div class="w-2 h-2 bg-purple-500 rounded-md"></div>
