                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div x-data="{ open: false, selectedUser: {{ $certificate->user ? json_encode($certificate->user) : 'null' }}, searchQuery: '', users: {{ json_encode($users ?? []) }} }">
                        ...
                        <div class="mt-1 relative">
                            ...
                            >
                                <span x-text="selectedUser ? selectedUser.name : 'აირჩიეთ მომხმარებელი'" class="block truncate dark:text-gray-300"></span>
                                                            ...
                                                            <li class="py-2 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 px-3 rounded" @click="selectedUser = user; open = false;">
                                                                <div class="flex items-center">
                                                                    <div class="ml-3">
                                                                        ...
                                                                        <p class="text-sm text-gray-500 dark:text-gray-400" x-text="user.email || 'ელ-ფოსტა არ არის'"></p>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                        </template>
                    ...
                    <div>
                        ...
                        <select id="speciality_id" name="speciality_id" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                            ...
                            @foreach($specialities ?? [] as $speciality)
                                <option value="{{ $speciality->id }}" {{ $certificate->speciality_id == $speciality->id ? 'selected' : '' }}>{{ $speciality->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <!-- Certificate Number -->
                    <div>
                        <x-label for="certificate_number" value="სერტიფიკატის ნომერი" class="text-gray-900 dark:text-white" />
                        <x-input id="certificate_number" type="text" name="certificate_number" :value="old('certificate_number', $certificate->certificate_number)" class="mt-1 block w-full" required />
                    ...
                    <div>
                        ...
                        <x-input id="release_date" type="date" name="release_date" :value="old('release_date', $certificate->release_date)" class="mt-1 block w-full" required />
                        <x-input-error for="release_date" class="mt-2" />
                    </div>

                    <!-- Lifetime Years -->
                    <div>
                        <x-label for="lifetime_years" value="მოქმედების ვადა (წლები)" class="text-gray-900 dark:text-white" />
                        <x-input id="lifetime_years" type="number" name="lifetime_years" :value="old('lifetime_years', $certificate->lifetime_years)" class="mt-1 block w-full" required />
                    ...
                    <div>
                        ...
                        <select id="status" name="status" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                            @foreach(['pending', 'approved', 'rejected', 'expired'] as $status)
                                <option value="{{ $status }}" {{ $certificate->status->value == $status ? 'selected' : '' }}>{{ ucfirst($status) }}</option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <x-input id="location" type="text" name="location" :value="old('location', $certificate->location)" class="mt-1 block w-full" />
                    ...
                    <div>
                        ...
                        <x-input id="education" type="text" name="education" :value="old('education', $certificate->education)" class="mt-1 block w-full" />
                    ...
                    <div>
                        ...
                        <x-input id="experience" type="text" name="experience" :value="old('experience', $certificate->experience)" class="mt-1 block w-full" />
                    ...
                    <div>
                        ...
                        <x-input id="social" type="text" name="social" :value="old('social', $certificate->social)" class="mt-1 block w-full" />
                    ...
                    <div>
                        ...
                        <x-input id="phone_number" type="text" name="phone_number" :value="old('phone_number', $certificate->phone_number)" class="mt-1 block w-full" />
                    ...
                    <div>
                        ...
                        <x-input id="email" type="email" name="email" :value="old('email', $certificate->email)" class="mt-1 block w-full" />
                    ...
                    <div>
                        ...
                        <x-input id="score" type="number" step="0.01" name="score" :value="old('score', $certificate->score)" class="mt-1 block w-full" />
                    ...
                    <div>
                        ...
                        <x-input id="rate" type="number" step="0.01" name="rate" :value="old('rate', $certificate->rate)" class="mt-1 block w-full" />
                    ...
                    <div>
                        ...
                        <x-input id="jury_count" type="number" name="jury_count" :value="old('jury_count', $certificate->jury_count)" class="mt-1 block w-full" />
