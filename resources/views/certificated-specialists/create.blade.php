<x-layout>
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('certificated-specialists') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition ease-in-out duration-150">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
            <form action="{{ route('admin.certificates.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <!-- Certificate Number -->
                    <div>
                        <x-label for="certificate_number" value="Certificate Number" />
                    ...
                    <!-- Lifetime Years -->
                    <div>
                        <x-label for="lifetime_years" value="Lifetime (Years)" />
                    ...
                    <!-- Social Media Links -->
                    <div>
                        <x-label for="social" value="Social Media Links (comma-separated)" />
                    ...
                    <!-- Jury Count -->
                    <div>
                        <x-label for="jury_count" value="Jury Count" />
                    ...
                    <!-- Stars -->
                    <div>
                        <x-label for="stars" value="Stars" />
                        <x-input id="stars" type="number" min="0" max="5" name="stars" :value="old('stars', 0)" class="mt-1 block w-full" />
                        <x-input-error for="stars" class="mt-2" />
                    </div>
                </div>
